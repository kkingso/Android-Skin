...
import com.kkw.skindemo.skin.widget.SkinCompatEditText;
...
public class SkinMaterialTextInputLayout extends TextInputLayout implements SkinCompatSupportable {
    ...
    private void loadCounterTextColorResFromAttributes(@StyleRes int resId) {
        if (resId != INVALID_ID) {
            TypedArray counterTA = getContext().obtainStyledAttributes(resId, com.kkw.skindemo.skin.R.styleable.SkinTextAppearance);
            if (counterTA.hasValue(com.kkw.skindemo.skin.R.styleable.SkinTextAppearance_android_textColor)) {
                mCounterTextColorResId = counterTA.getResourceId(com.kkw.skindemo.skin.R.styleable.SkinTextAppearance_android_textColor, INVALID_ID);
            }
            counterTA.recycle();
        }
    ...
    private void loadErrorTextColorResFromAttributes(@StyleRes int resId) {
        if (resId != INVALID_ID) {
            TypedArray errorTA = getContext().obtainStyledAttributes(resId, com.kkw.skindemo.skin.R.styleable.SkinTextAppearance);
            if (errorTA.hasValue(com.kkw.skindemo.skin.R.styleable.SkinTextAppearance_android_textColor)) {
                mErrorTextColorResId = errorTA.getResourceId(com.kkw.skindemo.skin.R.styleable.SkinTextAppearance_android_textColor, INVALID_ID);
            }
            errorTA.recycle();
        }
