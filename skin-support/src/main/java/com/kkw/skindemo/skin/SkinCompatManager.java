...
import com.kkw.skindemo.skin.inflater.SkinLayoutInflater;
import com.kkw.skindemo.skin.load.SkinAssetsLoader;
import com.kkw.skindemo.skin.load.SkinBuildInLoader;
import com.kkw.skindemo.skin.load.SkinNoneLoader;
import com.kkw.skindemo.skin.load.SkinPrefixBuildInLoader;
import com.kkw.skindemo.skin.observe.SkinObservable;
import com.kkw.skindemo.skin.res.SkinCompatResources;
import com.kkw.skindemo.skin.utils.SkinPreference;
import com.kkw.skindemo.skin.wrapper.SkinActivityLifecycle;
import com.kkw.skindemo.skin.wrapper.SkinWrapper;
...
public class SkinCompatManager extends SkinObservable {
    ...
    /**
     * 初始化换肤框架，监听Activity生命周期. 通过该方法初始化，应用中Activity无需继承{@link com.kkw.skindemo.skin.inflater.SkinCompatActivity}.
     *
     ...
     *
     * @param inflater 在{@link com.kkw.skindemo.skin.inflater.SkinCompatViewInflater#c(Context, String, String)}方法中调用.
     * @return
     */
     ...
     * 自定义View换肤时，可选择添加一个{@link SkinLayoutInflater}
     *
     * @param inflater 在{@link com.kkw.skindemo.skin.inflater.SkinCompatViewInflater#createView(Context, String, String)}方法中最先调用.
     * @return
     */
    @Deprecated
